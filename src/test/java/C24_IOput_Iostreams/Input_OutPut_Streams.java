...
public class Input_OutPut_Streams {
	...
	public void functionality() throws Exception{
		...
		FileInputStream fi = new FileInputStream("D:\\Swamy Testing\\Results Data\\Data\\HMS_Data_DrivenLogin.xls");
		Workbook w = Workbook.getWorkbook(fi);
		Sheet s = w.getSheet("MTC");


		//Create the result file under the result folder		  
		FileOutputStream fo = new FileOutputStream("D:\\Swamy Testing\\Results Data\\Se Create Data\\Siva1_Result.xls");
